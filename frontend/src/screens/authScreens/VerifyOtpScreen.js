        ...
        <div className="login-container d-flex align-items-center justify-content-center">
          <Form className="login-form text-center">
            ...
            <div className="mb-4 font-weight-light ">
              <p>
                We've sent an verify code to your phone <br />
                Please enter it below. <span onClick={Back}>Wrong number?</span>
              </p>
            </div>
            ...
            <div className="pt-2">
              <p className="call-otp font-weight-normal text-left">
                We will call you in {60} sec{" "}
              </p>
              <p onClick={resetOtp} className="font-weight-normal text-right">
                Re-sent
              </p>
            </div>
            <Button
